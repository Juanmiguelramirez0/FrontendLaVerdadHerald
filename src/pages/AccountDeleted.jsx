...
export default function AccountDeleted() {
  ...
  const handleLogout = () => {
    ...
    showNotification("You have been successfully logged out", "info", 4000);
  ...
  const handleConfirmDelete = () => {
    ...
    setUser(null);
    showNotification("Your account has been successfully deleted", "error", 4000);
  ...
  const handleChangePassword = () => {
    ...
    showNotification("Your password has been successfully updated", "success", 4000);
  };
          ...
          <Group align="flex-start" spacing="xl">
            ...
            >
              ...
              <Text ta="center" c="dimmed" fz="sm" mb="lg">
                Joined {user?.joined || "November 2, 2025"}
              </Text>
              ...
              <Group gap="xs" mb="sm">
                <IconMail size={18} />
                <Text size="sm">
                  {user?.email || "juanmiguelramirez@student.laverdad.edu.ph"}
                </Text>
              </Group>
